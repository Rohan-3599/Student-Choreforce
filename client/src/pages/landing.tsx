...
import { ShoppingCart, SprayCan, WashingMachine, ArrowRight, Shield, Zap, Users } from "lucide-react";
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-lg text-muted-foreground max-w-lg leading-relaxed" data-testid="text-hero-subtitle">
                Post tasks, set your budget, and let trusted USC students handle your grocery shopping, dorm cleaning, and laundry. Focus on what matters most.
              </p>
      ...
      <section className="py-20 px-6 bg-card/50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12 space-y-3">
            ...
            <p className="text-muted-foreground max-w-md mx-auto">Three simple steps to get your tasks completed</p>
          </div>
          <div className="grid sm:grid-cols-3 gap-6">
            <StepCard step="1" title="Post a Task" description="Describe your chore, set a location, and name your price." />
            <StepCard step="2" title="Get Matched" description="A fellow Trojan claims your task and gets to work." />
            <StepCard step="3" title="Task Complete" description="Review the work, confirm completion, and pay up." />
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid sm:grid-cols-3 gap-6">
            ...
            <FeatureCard
              icon={Users}
              title="Earn Money"
              description="Pick up tasks that fit your schedule and earn extra cash between classes."
            />
          </div>
        </div>
      </section>
  ...
  return (
    <Card className="hover-elevate">
      <CardContent className="p-5 space-y-3">
        ...
        <div className="text-xs font-medium text-muted-foreground">Avg. {price}</div>
      </CardContent>
    </Card>
  );
}
