...
import { Zap, LogOut, ArrowLeft, ClipboardList } from "lucide-react";
        ...
        <Tabs defaultValue="posted">
          ...
          <TabsContent value="posted" className="mt-6">
            {postedLoading ? (
              ...
              <EmptyState message="You haven't posted any tasks yet. Create one to get help!" />
            ) : (
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <TabsContent value="claimed" className="mt-6">
            {claimedLoading ? (
              ...
              <EmptyState message="You haven't claimed any tasks yet. Browse open tasks to get started!" />
            ) : (
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
